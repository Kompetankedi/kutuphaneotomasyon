...
namespace kutuphaneotomasyon
{
    public partial class FrmYabancıKitaplar : Form
    {
        ...
        private void list()
        {
            ...
            { con.Open(); }
            SqlDataAdapter da = new SqlDataAdapter("select * from tbl_YabancıKitaplar", con);
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into tbl_YabancıKitaplar (KitapNo,KitapRaf,KitapAdi,KitapYazar) values (@p1,@p2,@p3,@p4)", con);
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("DELETE FROM tbl_YabancıKitaplar WHERE id=" + secilenid + "", con);
                cmd.ExecuteNonQuery();
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand komutguncelle = new SqlCommand("Update tbl_YabancıKitaplar set KitapNo=@a1,KitapRaf=@a2,KitapAdi=@a3,KitapYazar=@a4 where id=@a5", con);
